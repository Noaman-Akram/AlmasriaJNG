...
formatWorkTypes(workTypesInput: any): string {
  ...
  //show a notifiation in the system of the recent upadte that shows there is a successful inseration 
  //I can aenable realtime to show things in realtime 
  // the notification is always open to listen for all changes in the activity log and show it to all users in realtime 
